...
import br.com.opah.heroesapi.usecase.impl.FavoriteHeroUseCaseImpl;
...
public class FavoriteHeroUseCaseImplTest {

    @InjectMocks
    private FavoriteHeroUseCaseImpl favoriteHeroUseCase;
